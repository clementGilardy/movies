...
class SecurityController extends Controller
{
    ...
    public function showProfilAction($id)
    {
        ...
        if($id != null)
        {
            $repository = $this->getDoctrine()->getManager()->getRepository('MoviesUserBundle:User');
            $user = $repository->find($id);
        }

        return $this->render('MoviesUserBundle:Security:profil.html.twig',array('user'=>$user));
    }
